...
// 대한민국의 모든 시/도 및 시/군/구 목록 데이터
// 이 구조를 기반으로 나중에 백엔드에서 받아오도록 변경할 수 있습니다.
export const regionData = {
  ...
  "경기도": [
    ...
    "남양주시", "안양시", "평택시", "의정부시", "파주시", "시흥시", "김포시", 
    "광명시", "광주시", "군포시", "오산시", "이천시", "안성시", "하남시", 
    "의왕시", "양주시", "포천시", "동두천시", "과천시", "여주시", "가평군", 
    "양평군", "연천군"
  ],
  "인천": [
    "계양구", "남동구", "미추홀구", "부평구", "서구", "연수구", "중구", "동구",
    "강화군", "옹진군"
  ],
  "부산": [
